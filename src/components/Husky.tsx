...
import '../styles/Husky.css'; // This will link to your exact CSS

const Husky = ({ isMirrored, isClosedEye, isError, isHappy, isWagging, onInteract }: any) => {
    ...
    useEffect(() => {
        ...
        const handleMouseMove = (e: MouseEvent) => {
            ...
            eyes.forEach(eye => {
                ...
                (eye as HTMLElement).style.setProperty('--eyeX', `${eyeX}px`);
                (eye as HTMLElement).style.setProperty('--eyeY', `${eyeY}px`);
            });
    ...
    return (
        <div className="absolute inset-0 w-full h-full flex items-center justify-center z-20" onClick={onInteract}>
            <div className="husky-scene absolute top-1/2 left-1/2" style={{ transform: transformStyle }} data-mirrored={isMirrored ? "true" : "false"}>
