...
export default function Contact() {
  ...
  return (
    <section className="bg-white py-24 px-4 md:px-12 text-black" id="contact">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        >
          ...
          <p className="text-zinc-600 mb-10 max-w-md leading-relaxed">
          ...
          <div className="flex flex-col gap-5 mb-12">
            ...
            <a
              ...
              className="flex items-center gap-3 text-zinc-700 hover:text-[#D2042D] transition"
            >
              <MailIcon />
          ...
          <a
            href="/Swaroop.cv"
            download
            className="inline-block px-6 py-3 bg-[#D2042D] text-white text-xs font-bold uppercase tracking-widest hover:bg-[#FF3131] transition"
          >
            Download CV
          </a>
        ...
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          className="bg-white border border-zinc-200 p-8 rounded-xl shadow-sm"
        >
...
function Input({ placeholder, value, onChange, type = "text" }) {
  return (
    <input
      ...
      className="w-full border border-zinc-200 p-3 rounded-md focus:outline-none focus:border-[#D2042D] transition"
      required
    />
  );
}
...
function Textarea({ placeholder, value, onChange }) {
  return (
    <textarea
      ...
      value={value}
      onChange={(e) => onChange(e.target.value)}
      className="w-full border border-zinc-200 p-3 rounded-md focus:outline-none focus:border-[#D2042D] transition resize-none"
      required
    />
  );
}
