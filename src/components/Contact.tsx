...
export default function Contact() {
  ...
  return (
    <div className="relative w-full h-[100svh] bg-[#09090b] overflow-hidden flex items-center justify-center font-sans">
      ...
      <div className="relative z-10 w-full max-w-[90rem] mx-auto px-5 md:px-12 flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-12 xl:gap-20 h-full pt-[15svh] lg:pt-[18svh] pb-[4svh] lg:pb-[8svh]">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="text-[11vw] sm:text-6xl lg:text-[5rem] font-black leading-[0.9] tracking-tight uppercase mb-6 lg:mb-8">
          ...
          {/* 🚨 FIX: HORIZONTAL INTERACTIVE LOGOS ── */}
          <motion.div variants={fadeUp} className="flex flex-row flex-wrap items-center gap-3 lg:gap-4 mb-6 lg:mb-8">
            <ExpandableLink href="mailto:swaroopchoudary118@gmail.com" label="Email" value="swaroopchoudary118@gmail.com" icon={<MailIcon />} />
            <ExpandableLink href="tel:+917780566636" label="Phone" value="+91 7780 566 636" icon={<PhoneIcon />} />
            <ExpandableLink href="https://linkedin.com/in/jasti-swaroop-choudary-00b3612a7/" label="LinkedIn" value="Swaroop Choudary" icon={<LinkedinIcon />} />
          </motion.div>

          {/* 🚨 FIX: TALLER HUSKY CONTAINER FOR FULL VISIBILITY */}
          <motion.div variants={fadeUp} className="hidden sm:block relative w-full h-[200px] xl:h-[260px] bg-[#0c0c0e]/80 backdrop-blur-md border border-zinc-800/60 rounded-3xl lg:rounded-[2rem] overflow-hidden group cursor-pointer shadow-2xl">
          ...
          {/* 🚨 FIX: RESTORED SIGNATURE FOOTER */}
          <motion.div variants={fadeUp} className="mt-6 lg:mt-8 hidden sm:flex items-center gap-5 opacity-90">
            <svg className="w-12 lg:w-16 h-auto text-white drop-shadow-md" viewBox="0 0 1024 672" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-[1px] h-5 lg:h-6 bg-zinc-700/50" />
            <p className="text-lg lg:text-xl font-serif italic text-zinc-300/80 tracking-wide font-light">
              Swaroop Choudary
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="w-full bg-[#0c0c0e]/90 backdrop-blur-2xl border border-zinc-800/80 p-5 sm:p-8 lg:p-10 rounded-3xl lg:rounded-[2rem] shadow-2xl relative overflow-hidden flex flex-col">

            <div className="absolute top-0 right-0 w-64 h-64 bg-[#D2042D]/5 rounded-full blur-[80px] pointer-events-none" />

            <h3 className="text-sm sm:text-base lg:text-lg font-bold text-white mb-4 lg:mb-6 uppercase tracking-widest flex items-center gap-3">
              Send a Message
              <span className="h-[1px] flex-1 bg-gradient-to-r from-zinc-800 to-transparent" />
            </h3>

            <form onSubmit={handleSubmit} className="flex flex-col gap-3 sm:gap-4 lg:gap-6 relative z-10 overflow-y-auto scrollbar-hide pb-2">
              ...
              <button
                ...
                className={`w-full py-3.5 sm:py-4 lg:py-4 mt-2 flex justify-center items-center gap-3 text-white text-[10px] sm:text-[11px] font-black uppercase tracking-[0.2em] rounded-xl transition-all duration-300 overflow-hidden relative group ${isSuccess ? "bg-green-600" : "bg-[#D2042D] hover:bg-white hover:text-[#09090b]"
...
function ExpandableLink({ href, label, value, icon }: { href: string; label: string; value: string; icon: React.ReactNode }) {
  ...
  return (
    <a
      ...
      className={`group flex items-center h-12 sm:h-14 rounded-full transition-all duration-500 ease-[0.16,1,0.3,1] overflow-hidden border shadow-lg ${isExpanded
          ? "w-[240px] sm:w-[280px] bg-zinc-900 border-zinc-700" // Explicit w- instead of max-w for smoother rigid animation
          : "w-[48px] sm:w-[56px] bg-[#0c0c0e] border-zinc-800 text-zinc-400 hover:bg-[#D2042D] hover:border-[#D2042D] hover:text-white"
        }`}
    >
      {/* Icon Container */}
      ...
      <div className={`flex flex-col justify-center whitespace-nowrap transition-opacity duration-300 ${isExpanded ? "opacity-100 pr-6" : "opacity-0"}`}>
        <span className="text-[8px] sm:text-[9px] uppercase tracking-[0.2em] font-bold text-[#D2042D] mb-0.5">
          {label}
        </span>
...
// ─── SVG ICONS ───
const MailIcon = () => <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none"><rect x="2" y="4" width="20" height="16" rx="2" /><path d="M22 7L12 13L2 7" /></svg>;
const PhoneIcon = () => <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none"><path d="M22 16.92V20a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.27h3.09a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 8.91a16 16 0 0 0 6 6l.86-.86a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>;
const LinkedinIcon = () => <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect x="2" y="9" width="4" height="12" /><circle cx="4" cy="4" r="2" /></svg>;